...
ALTER FUNCTION public.actulizacions_resultats() OWNER TO vremar;
...
ALTER FUNCTION public.comproba_pacient(camp character varying, valor character varying) OWNER TO vremar;
...
ALTER FUNCTION public.determina_resultat(idprovatecnica bigint, idpacient bigint, resultat character varying) OWNER TO vremar;
...
ALTER FUNCTION public.dni_correct(dni character varying) OWNER TO vremar;
...
ALTER FUNCTION public.es_numeric(num_str character varying) OWNER TO vremar;
...
ALTER FUNCTION public.examina_resultats(id_pacient bigint, id_analitica bigint) OWNER TO vremar;
...
ALTER FUNCTION public.exemple(integer, integer) OWNER TO vremar;
...
ALTER FUNCTION public.exemple_txt(integer, integer) OWNER TO vremar;
...
ALTER FUNCTION public.insert_analitiques(iddoctor bigint, idpacient bigint, fecha character varying) OWNER TO vremar;
...
ALTER FUNCTION public.insert_resultats(idanalitica bigint, idprovatecnica bigint, resultats character varying) OWNER TO vremar;
...
ALTER FUNCTION public.insert_resultats(idanalitica bigint, idprovatecnica bigint, resultats character varying, dataresultat timestamp without time zone) OWNER TO vremar;
...
ALTER FUNCTION public.insert_resultats(idanalitica bigint, idprovatecnica bigint, resultats character varying, dataresultat character varying) OWNER TO vremar;
...
ALTER FUNCTION public.nous_pacients() OWNER TO vremar;
...
ALTER FUNCTION public.sumar1(integer) OWNER TO vremar;
...
ALTER FUNCTION public.update_resultats(id_analitica bigint, id_povatecnica bigint, resultat character varying) OWNER TO vremar;
...
ALTER FUNCTION public.valorar_idresultat(id_resultat bigint) OWNER TO vremar;
...
ALTER TABLE alarmes OWNER TO vremar;
...
ALTER TABLE alarmes_idalarma_seq OWNER TO vremar;
...
ALTER TABLE analitiques OWNER TO vremar;
...
ALTER TABLE analitiques_idanalitica_seq OWNER TO vremar;
...
ALTER TABLE catalegproves OWNER TO vremar;
...
ALTER TABLE doctors OWNER TO vremar;
...
ALTER TABLE doctors_iddoctor_seq OWNER TO vremar;
...
ALTER TABLE pacients OWNER TO vremar;
...
ALTER TABLE pacients_idpacient_seq OWNER TO vremar;
...
ALTER TABLE pacients_nous OWNER TO vremar;
...
ALTER TABLE provestecnica OWNER TO vremar;
...
ALTER TABLE provestecnica_idprovatecnica_seq OWNER TO vremar;
...
ALTER TABLE resultats OWNER TO vremar;
...
ALTER TABLE resultats_idresultat_seq OWNER TO vremar;
...
ALTER TABLE resultatsnous OWNER TO vremar;
...
--
-- Name: fk_idprovatecnica; Type: FK CONSTRAINT; Schema: public; Owner: vremar
--
